    ...
    - 협업 필터링
        > 메모리 기반 협업 필터링
            1) 사용자 기반 협업 필터링 -> 당신과 비슷한 상품을 산 고객은 이런 상품도 샀다
                1. 피어슨 상관관계, 코사인 유도, 자카드 계수 등 등장 
            2) 아이템 기반 협업 필터링 -> 방금 막 가입한 사용자에게 적용하기에 적합하다
        > 모델 기반 협업 필터링 -> 회귀/분류등 예측 모델을 학습해서 처리
    - 내용 기반 필터링 -> 영화라면 메타정보(제목, 감독, 장르, 배우, 평판 등등 간접지표를 통해 나타나는 정보에 주목)
